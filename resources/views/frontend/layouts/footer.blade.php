...
<script src="{{asset('frontend-theme/assets/jquery.js')}}"></script>

<!-- wow script -->
<script src="{{asset('frontend-theme/assets/wow/wow.min.js')}}"></script>

<!-- uniform -->
<script src="{{asset('frontend-theme/assets/uniform/js/jquery.uniform.js')}}"></script>


<!-- boostrap -->
<script src="{{asset('frontend-theme/assets/bootstrap/js/bootstrap.js')}}" type="text/javascript" ></script>

<!-- jquery mobile -->
<script src="{{asset('frontend-theme/assets/mobile/touchSwipe.min.js')}}"></script>

<!-- jquery mobile -->
<script src="{{asset('frontend-theme/assets/respond/respond.js')}}"></script>

<!-- gallery -->
<script src="{{asset('frontend-theme/assets/gallery/jquery.blueimp-gallery.min.js')}}"></script>


<!-- custom script -->
<script src="{{asset('frontend-theme/assets/script.js')}}"></script>
